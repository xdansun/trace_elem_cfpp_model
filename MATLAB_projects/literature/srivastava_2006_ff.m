function [sankey_matrix, phase_matrix, err_matrix] = srivastava_2006_ff
%% Script description 
...
esp_ash_output = [mean([89 89 73 73]) nan nan nan]*10^-2;

%% SO2 control 
% Table 1, srivastava 2006; after doing the math, the FF already removes
% about 89%, so if FF+wFGD removes 75%, then the wFGD basically does
% nothing 
