function [sankey_matrix, phase_matrix, error_matrix] = ...
    goodarzi_2004_trace_elem(trace_elem_input)
...
%%
% order is Hg, Se, As, and Cl in g/h
hg_in = [9.47 19.52 20.48 26.15 29.44 7.1];
coal_in = [mean(hg_in) nan nan nan]; 
% bot_ash_frac = 0.2; % fraction of coal ash that becomes bottom ash 

%% boiler
% bottom ash splits
%Hg, Se, As, and Cl partitioning
bot_hg = [0.110 0.2 0.168 0.061 0.267 0.12]; 
