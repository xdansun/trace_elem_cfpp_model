...
esp_ash_ratio = [mean([27 39 32])/100 nan nan nan];
...
%% wFGD 
wfgd_ratio = [mean([30 41 50])/100 nan nan nan]; % from Table 3. See Pavlish_back_of_envelop_calculations.xlsx for details on how these numbers were obtained  
...
gypsum_error_low = [0.49 0 0 0] - wfgd_ratio;
gypsum_error_high = [0.66 0 0 0] - wfgd_ratio;
