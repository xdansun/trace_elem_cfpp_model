function [sankey_matrix, phase_matrix, err_matrix] = kilgore_2002_csesp_wfgd
%% Script description 
...
%% SO2 control 
% Table ES-1
fgd_removal = [75-36 29-3 44 49-9 29-6 98-90]; % subtract off csesp, hsesp, and ff contribution in removal 
