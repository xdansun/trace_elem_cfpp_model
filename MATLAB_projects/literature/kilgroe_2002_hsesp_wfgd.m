function [sankey_matrix, phase_matrix, err_matrix] = kilgroe_2002_hsesp_wfgd
%% Script description 
...
esp_ash_output = [mean([0.09 0.06]) nan nan nan];

%% SO2 control 
% Table ES-1
fgd_removal = [49-9 29-6]; % subtract off csesp, hsesp, and ff contribution in removal 
