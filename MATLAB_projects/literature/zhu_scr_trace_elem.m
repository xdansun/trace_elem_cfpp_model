function [sankey_matrix, phase_matrix, error_matrix] = ...
    zhu_scr_trace_elem(trace_elem_input)
...
% Data from table 2
fa_ratio = [33.17 nan nan nan]; % define the mean as the partition coefficient 

%% wFGD splits 
% Data from Table 2 
wfgd_ratio = [74.82 nan nan nan] - fa_ratio; % wFGD removal 
