function [output_cell, study_name, apcd_combo] = laird_trace_elem_dsi_addon(i)
...
sample_removals = [0.917 0.989 0.9996 0.969 0.969 0.71 0.78 0.64 0.84 0.77];
...
esp_ash_output = [nan nan nan sample_removals(i)];
