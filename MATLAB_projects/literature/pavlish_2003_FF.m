function [sankey_matrix, phase_matrix, error_matrix] = ...
    pavlish_2003_FF(trace_elem_input)
...
esp_ash_ratio = [mean([58 56 44])/100 nan nan nan];
...
%% wFGD 
wfgd_ratio = [mean([71 57 61])/100 nan nan nan]; % from Table 3. See Pavlish_back_of_envelop_calculations.xlsx for details on how these numbers were obtained   
...
fly_error_low = [0.58 0 0 0] - esp_ash_ratio;
fly_error_high = [0.44 0 0 0] - esp_ash_ratio;
gypsum_error_low = [0.57 0 0 0] - wfgd_ratio;
gypsum_error_high = [0.71 0 0 0] - wfgd_ratio;
