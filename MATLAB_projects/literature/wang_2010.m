function [sankey_matrix, phase_matrix, err_matrix] = wang_2010
%% Script description 
...
%% ESP 
% Figure 8, Wang et al. Use plants 1-6 
esp_ash_output = [mean([0.37 0.48 0.10 0.06 0.17 0.24]) nan nan nan]; 

%% wFGD 
% Figure 8, Wang et al. Use plants 1-4
% calculate FGD contribution to overall removal 
gypsum_output = [mean([0.68 0.70 0.84 0.28] - [0.37 0.48 0.10 0.06]) nan nan nan]; % assume all of it goes into solids; ww_ratio from other scripts will assume a percentage enters water
