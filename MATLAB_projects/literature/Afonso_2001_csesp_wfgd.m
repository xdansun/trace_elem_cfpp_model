function [sankey_matrix, phase_matrix, err_matrix] = Afonso_2001_csesp_wfgd
%% Script description 
...
esp_ash_output = [42 nan nan nan]*10^-2;

%% SO2 control 
% Table 3, use average of coal types as removal; 
% just csesp and wfgd removals 
% 45 - 42 = 3 (14 data points) 
gypsum_output = [3 nan nan nan]*10^-2; % assume all of it goes into solids; ww_ratio from other scripts will assume a percentage enters water
