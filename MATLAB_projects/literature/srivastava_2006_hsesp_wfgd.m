function [sankey_matrix, phase_matrix, err_matrix] = srivastava_2006_hsesp_wfgd
%% Script description 
...
%% PM control
% Table 1, perform average across coal ranks to obtain removal  
esp_ash_output = [(3*0.11+4*0)/7 nan nan nan];

%% no SO2 control 
% Table 1, srivastava 2006 
gypsum_output = [(3*0.28+3*0.08)/6 nan nan nan]; % assume all of it goes into solids; ww_ratio from other scripts will assume a percentage enters water
