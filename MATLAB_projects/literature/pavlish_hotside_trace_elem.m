function [sankey_matrix, phase_matrix, error_matrix] = ...
    pavlish_hotside_trace_elem(trace_elem_input)
...
esp_ash_ratio = [median([4 29])/100 nan nan nan];
...
%% wFGD 
wfgd_ratio = [median([22 25])/100 nan nan nan]; % from Table 3. Take the difference of ESP cold and ESP cold + FGD wet 
...
gypsum_error_high = [0.25 0 0 0] - wfgd_ratio;
