function [sankey_matrix, phase_matrix, err_matrix] = kellie_2004_esp
%% Script description 
% contains removal/partitioning data of trace elements (TE) from 
% Kellie et al. (2004)
% Title: Mercury emissions from a 100-MW wall-fired boiler as measured by semicontinuous mercury monitor and Ontario Hydro Method
...
%% PM control
% Figure 7, Kellie et al. 2004; this method assumes that almost no Hg is
% particulate bound before and after 
% inlet = 15000
