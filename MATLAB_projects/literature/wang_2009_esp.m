function [sankey_matrix, phase_matrix, err_matrix] = wang_2009_esp
%% Script description 
...
%% ESP 
% Figure 2, Wang et al. Plants 3-5; Add up the input, add up the output,
% that ratio is the emissions fraction. 1 minus gives the esp_ash_output
inlet = [1 31.5+5.5 5]; 
outlet = [0.8 14+11 5]; % this assumes that the flue gas is constant 
esp_ash_output = [1 - mean(outlet./inlet) nan nan nan];
