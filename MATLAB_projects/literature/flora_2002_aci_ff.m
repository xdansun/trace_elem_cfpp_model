function [output_cell, study_name, apcd_combo] = flora_2002_aci_ff
%% Script description 
...
esp_ash_output = [mean([12.2 84.1 88.7 68.2 31.0 42.8 65.6 62.7 3.7 5.4 90.0 87.5 ...
    79.6 96.5 80.8 73.2 32.8 96.7 92.5 91.8 87.7 86.2 10.2]) nan nan nan]*10^-2;
