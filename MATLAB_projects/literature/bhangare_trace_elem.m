...
% based on the Bhangare 2011 paper 
% India power plants
% can't be used at the moment because it needs the ash content in the coal 
global bot_ash_frac; 
...
% assume 1 kg of coal  
hg_in = [2.31 9.18 13.21 4.40 8.14]*10^-3; % in mg
as_in = [1.14 1.39 2.20 1.55 1.55]*10^-3; % in mg
