...
% this function inputs EIA data and selects for coal generators, generators 
% that are linked one-to-one with and plants with total nameplate capacity 
% greater than 1 MW. All data exclusions provided in SI. 
% Script also calculates the generation lost from the
...
% ann_coal_gen - total generation of coal plants in the U.S. in MWh
% num_coal_plants - number of coal plants operating in 2015
