function part_lit_out = trace_elem_partition_lit_addon(partitioning_lit)

%% 
% as noted in the SI Section on partitioning of air pollution control, some
% air pollution control combination have a single study. For those control
% combinations, we use every single data point in those studies instead of
% the average in those studies
%
% input
% partitioning_lit (cell) - list of studies with their air pollution
...
%
% output
% part_lit_out (cell) - same as partitioning lit with additional points for
% air pollution controls with only one study 
