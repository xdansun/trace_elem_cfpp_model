...
% 
% inputs:
% coal_gen_boiler_wcutoff (table) - the main coal generator boiler link 
% ann_coal_gen (double) - the annual generation from the entire coal fleet 
% num_coal_plants (int) - number of coal plants operating in year
% year (int) - Year of analysis. Either 2015, 2016, or 2010. 
%
% outputs:
% coal_generator_boiler_table (table) - a table containing cfpps at the generator
...
% coal_purchase_nowc_domestic (table) - a table of coal purchases that excludes
