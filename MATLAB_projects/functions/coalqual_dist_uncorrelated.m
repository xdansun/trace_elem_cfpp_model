function [cfpp_cq_hg, cfpp_cq_se, cfpp_cq_as, cfpp_cq_cl, plants_no_cl_data] = ...
    coalqual_dist_uncorrelated(coal_gen_boiler_apcd, fuel_purchases, plant_months, LDL_flag)
...
% Chlorine 
% plants_no_cl_data (array) - some plants have insufficient data to model
% chlorine emissions. We keep track of them by plant ids. 
