...
%% need to code dFGD and FF together; uncertain how to handle plants without dFGD + FF
% exceptions are {'6204_3';'3403_3';'3403_4';'7504_2'}; removing them is
% not a big loss from a generation perspective 
