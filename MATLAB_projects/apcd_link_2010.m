...
[num,txt,raw] = xlsread('../data/eia8602010/EnviroAssocY2010.xls','Boiler_FGP');
column_numbers = 1:4; % identify columns of interest from raw data files
...
boiler_pm.Properties.VariableNames = {'Utility','Plant_Code','Boiler_ID','PM_ID'}; 
...
[num,txt,raw] = xlsread('../data/eia8602010/EnviroAssocY2010.xls','Boiler_FGD');
column_numbers = 1:4; % identify columns of interest from raw data files
row_start = 1;  % identify row number in which spreadsheet starts; row_start is the row of the header 
boiler_so2 = table_scrub(raw, column_numbers, row_start); % merge the table together
boiler_so2.Properties.VariableNames = {'Utility','Plant_Code','Boiler_ID','SO2_ID'}; 
